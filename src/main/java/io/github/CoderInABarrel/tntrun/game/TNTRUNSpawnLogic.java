...
import io.github.CoderInABarrel.tntrun.TNTRUN;
import io.github.CoderInABarrel.tntrun.game.map.TNTRUNMap;

public class TNTRUNSpawnLogic {
    private final GameSpace gameSpace;
    private final TNTRUNMap map;

    public TNTRUNSpawnLogic(GameSpace gameSpace, TNTRUNMap map) {
    ...
    public void spawnPlayer(ServerPlayerEntity player) {
        ...
        if (pos == null) {
            TNTRUN.LOGGER.error("Cannot spawn player! No spawn is defined in the map!");
            return;
        }
